...
<main class="wrap">
  <header>
    ...
    <div class="verdict" style="background: rgba(16, 185, 129, 0.15); border-left: 6px solid #10b981; padding: 24px 28px;">
      <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
        <span class="badge-green" style="font-size: 0.9rem; padding: 4px 12px; text-transform: uppercase;">RECOMENDAÇÃO: COMPRA SISTEMÁTICA / ATIVO LÍDER DE TENDÊNCIA</span>
        <span style="color: #6ee7b7; font-weight: 700; font-size: 0.95rem;">• AVALIAÇÃO: EXCELENTE OPORTUNIDADE DE INVESTIMENTO</span>
      </div>
      <strong style="font-size: 1.15rem; color: #ffffff;">VALE A PENA INVESTIR NA MICRON (MUTC34)? RESPOSTA DIRETA: SIM!</strong><br>
      A Micron Technology é atualmente uma das oportunidades mais assimétricas do complexo de Inteligência Artificial global. A companhia rompeu com o padrão tradicional de "commodity de memória volátil" ao se consolidar como <strong>fornecedora crítica e indispensável de High Bandwidth Memory (HBM3E e HBM4)</strong> para a NVIDIA e os maiores datacenters do mundo, com <strong>100% de sua capacidade fabril já contratada e vendida até 2027</strong>. Além de entregar um <strong>Momentum 12-1 de +480,30%</strong> no modelo quantitativo do <code>iitauquant</code>, a Micron ostenta mais de <strong>US$ 100 bilhões em patrimônio líquido</strong> e caixa líquido de US$ 18,6 bilhões.
      <div style="margin-top: 12px; padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.15); font-size: 0.98rem; color: #e2e8f0;">
        ⚠️ <strong>A ÚNICA CONDICIONANTE OBRIGATÓRIA:</strong> Nunca faça <i>Buy & Hold passivo sem stop</i>. Como qualquer empresa de semicondutores sujeita a ciclos de capex, o investidor deve manter <strong>disciplina quantitativa com Trailing Stop móvel em R$ 832,87 (2.5x ATR)</strong> e limitar o ativo a 5%-7,5% da carteira.
      </div>
    </div>
  </header>
  ...
  <!-- SEÇÃO 0: VEREDITO FORMAL: VALE A PENA INVESTIR NA MICRON? -->
  <section style="border: 2px solid var(--green); background: linear-gradient(180deg, #f0fdf4 0%, #ffffff 100%);">
    <div style="display:flex; justify-content:space-between; align-items:center; flex-wrap:wrap; gap:10px; margin-bottom:15px;">
      <h2 style="color: #065f46; margin:0;">Veredito Executivo: Vale a Pena Investir na Micron Technology (MUTC34)?</h2>
      <span class="badge-green" style="font-size: 0.95rem; padding: 6px 14px;">DECISÃO: COMPRA RECOMENDADA</span>
    </div>

    <p style="font-size: 1.05rem; line-height: 1.6; color: #1e293b;">
      Com base na confluência de <strong>fundamentos industriais, balanço contábil auditado na SEC, modelos de fatores Fama-French e o motor sistemático Momentum ATR do laboratório iitauquant</strong>, o investimento em Micron Technology via BDR <code>MUTC34</code> na B3 é classificado como <strong>ALTAMENTE ATRATIVO</strong>. Veja abaixo o detalhamento dos prós, riscos e plano de ação:
    </p>

    <div class="grid three" style="margin-top: 20px;">
      <div class="card positive" style="border: 1px solid #86efac; background: #ffffff;">
        <span class="tag" style="background:#dcfce7; color:#15803d;">Os 5 Grandes Motores (Por que Vale a Pena)</span>
        <ul style="padding-left:18px; margin:8px 0; font-size:0.92rem; color:#1e293b;">
          <li><strong>Oligopólio da Memória HBM:</strong> Monopólio tripartite (Micron, SK Hynix e Samsung) da memória indispensável para GPUs de IA. A Micron consome 30% menos energia que as rivais.</li>
          <li><strong>100% Vendido até 2027:</strong> A capacidade produtiva dos próximos 2 anos está totalmente contratada por contratos plurianuais com a NVIDIA, Google, Meta e Microsoft.</li>
          <li><strong>Balanço Fortaleza:</strong> US$ 100,72 bilhões em patrimônio líquido, US$ 25 bilhões em caixa e apenas US$ 6,38 bilhões em dívidas (caixa líquido > US$ 18,6 bi).</li>
          <li><strong>Valuation Razoável (Fator Valor):</strong> Negocia a múltiplos de P/B muito mais atraentes (~2x a 3x) que NVIDIA (50x) ou Palantir (40x).</li>
          <li><strong>Apoio do Governo dos EUA:</strong> US$ 6,14 bilhões a fundo perdido do US CHIPS Act para construção de novas megafabs nos EUA.</li>
        </ul>
      </div>

      <div class="card negative" style="border: 1px solid #fca5a5; background: #ffffff;">
        <span class="tag" style="background:#fee2e2; color:#b91c1c;">Riscos & Quem NÃO Deve Investir</span>
        <ul style="padding-left:18px; margin:8px 0; font-size:0.92rem; color:#1e293b;">
          <li><strong>Ciclicidade Histórica de Chips:</strong> No passado, quedas na demanda de PCs/smartphones derrubavam a ação em -50% a -75% (como no inverno tech de 2022).</li>
          <li><strong>Proibido "Comprar e Esquecer":</strong> Não invista se você não pretende usar stop loss. A disciplina de sair no stop é o que protege contra o fim do ciclo.</li>
          <li><strong>Volatilidade Acima da Média:</strong> O ATR diário é de R$ 37,47 (~4,0% de oscilação por dia). Exige estômago para oscilações intradiárias.</li>
          <li><strong>Risco de Capex dos Hyperscalers:</strong> Se os gigantes de nuvem cortarem subitamente os investimentos em datacenters de IA, as margens sofrerão compressão.</li>
        </ul>
      </div>

      <div class="card neutral" style="border: 1px solid #93c5fd; background: #ffffff;">
        <span class="tag" style="background:#e0f2fe; color:#0369a1;">Plano Operacional Recomendado</span>
        <div style="font-size:0.92rem; color:#1e293b; line-height:1.6;">
          <p style="margin:4px 0;"><strong>• Preço de Entrada:</strong> Em torno de <strong>R$ 926,54</strong> (suportado pela MM20 em R$ 843,59).</p>
          <p style="margin:4px 0;"><strong>• Trailing Stop Inicial:</strong> <strong>R$ 832,87</strong> (2.5x ATR, corte estrito de perdas).</p>
          <p style="margin:4px 0;"><strong>• Realização Parcial 1:</strong> Venda de 30% em <strong>R$ 980,00</strong> (+5,8%).</p>
          <p style="margin:4px 0;"><strong>• Realização Parcial 2:</strong> Venda de 30% em <strong>R$ 1.083,08</strong> (+16,9% no topo anual).</p>
          <p style="margin:4px 0;"><strong>• Alvo Final de Superciclo:</strong> R$ 1.200,00 (+29,5%).</p>
          <p style="margin:4px 0;"><strong>• Alocação Máxima:</strong> 5% a 7,5% da carteira de renda variável.</p>
        </div>
      </div>
    </div>
  </section>
