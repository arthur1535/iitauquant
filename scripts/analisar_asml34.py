"""Análise quantitativa e fundamentalista de ASML Holding (ASML / ASML34)."""
...
OUTPUT_DIR = ROOT / "results" / "asml_research"
...
def main():
    tickers = ["ASML", "ASML34.SA", "SMH", "NVDA", "TSM", "SPY"]
    ...
    res_df.to_csv(OUTPUT_DIR / "asml_comparative_metrics.csv", index=False)
    print("\n" + "=" * 80)
    print("MÉTRICAS COMPARATIVAS QUANTITATIVAS (ASML / ASML34 / BENCHMARKS):")
