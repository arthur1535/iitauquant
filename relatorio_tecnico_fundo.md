...
**Ponto 2 — Limiares do gatilho.** Sinal: spread de crédito high yield (FRED, `BAMLH0A0HYM2`), como z-score contra média móvel de 3 anos. Calibração: marcar visualmente onde ficam 2008, 2011, 2015-16, 2020, 2022-23 na série de z-score; o limiar de **entrada** é o valor que capturaria a maioria dessas crises sem disparar demais em período normal; o limiar de **saída** (mais folgado — histerese) calibra-se pelo tempo típico de normalização das crises. Ponto de partida convencional: entrada em z > 1,0, saída em z < 0,5.
